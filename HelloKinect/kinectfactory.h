...
public:
    ...
    KinectFrameProtocol* getBoneFrame();
    KinectFrameProtocol* getFunnyManFrame();
    //释放关闭颜色帧
...
private:
    ...
    std::shared_ptr<KinectBone> mpBoneObj;
    std::shared_ptr<KinectFunnyMan> mpFunnyManObj;
};
